...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <p class="text-stone-600 font-light leading-relaxed mb-8">
        Работа со старым фондом требует понимания конструктива здания, согласований с КГИОП и опыта реставрации. Ошибки здесь обходятся дорого. Бюро LAGODA специализируется на объектах Санкт-Петербурга и знает все нюансы работы с историческими зданиями.
      </p>
    `,
  },
  {
    ...
    content: `
      ...
      <p class="text-stone-600 font-light leading-relaxed mb-8">
        В бюро LAGODA мы фиксируем стоимость на этапе договора. Вы получаете детальную смету с разбивкой по этапам и материалам. Никаких скрытых платежей — только прозрачная работа с вашим бюджетом.
      </p>
    `,
  },
  {
  ...
  },
  {
    ...
    content: `
      ...
      <div class="bg-stone-50 p-8 mt-12">
        <p class="text-sm text-stone-500 mb-4">В бюро LAGODA мы проводим бесплатную консультацию перед началом проекта. Вы получите предварительную оценку бюджета, сроков и увидите примеры наших работ в Петербурге.</p>
